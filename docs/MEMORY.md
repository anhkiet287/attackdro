...
- **Reactive (soft T=0.25) @8/255 — 3-SEED LOCKED (paper headline reactive row):** **union 41.90±0.22** (s0 41.7/s1 42.2/s2 41.8), **l1 48.10±0.43**, clean ~80, train==eval, W&B online. Tight spread (0.22pp, F8). Trails RAMP 46.1 by −4.2pp. **This is the CARD-PB v2 comparison target:** v2 success = union within ±0.3 of 41.90 AND l1 drop <2pp vs 48.10 AND FLOPs≤0.60. `results/reactive_vs_predictive_3seed.md`.
